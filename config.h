...
/* use `fc-list | grep -i fontname` to get valid font names */
static const char *fonts[] = { "xos4 Terminus:style=Bold:size=12" };
static const char dmenufont[] = "xos4 Terminus:style=Bold:size=12";
